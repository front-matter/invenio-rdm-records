...
class JournalCrossrefDumper(DumperMixin):
    """Dumper for crossref serialization of 'Journal' custom field."""

    def post_dump(self, data, original=None, **kwargs):
        """Adds the journal information as a related identifier in the Crossref metadata."""
        _original = original or {}
        custom_fields = _original.get("custom_fields", {})
        journal_data = custom_fields.get("journal:journal", {})
